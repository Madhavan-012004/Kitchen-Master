...
public class Orders {
    ...
    // Waiter Acknowledgement: true = customer order is pending waiter approval
    // before KOT
    ...
    public LocalDateTime getKotPrintedAt() {
        return kotPrintedAt;
    }

    public void setKotPrintedAt(LocalDateTime kotPrintedAt) {
        this.kotPrintedAt = kotPrintedAt;
    }

    public Boolean getBillRequested() {
    ...
    public void setBillRequestedAt(LocalDateTime billRequestedAt) {
        this.billRequestedAt = billRequestedAt;
    }
    ...
    public String getMergedTables() {
        return mergedTables;
    }

    public void setMergedTables(String mergedTables) {
    ...
    public Boolean getPrintWithGst() {
        return printWithGst;
    }

    public void setPrintWithGst(Boolean printWithGst) {
        this.printWithGst = printWithGst;
    }

    public Boolean getWaitingWaiterAck() {
        return waitingWaiterAck;
    }

    public void setWaitingWaiterAck(Boolean waitingWaiterAck) {
        this.waitingWaiterAck = waitingWaiterAck;
    }
    ...
    public enum OrderType {
        DINE_IN, TAKEAWAY, LINE_POS, LINE, DELIVERY
    }
    ...
    public static class OrdersBuilder {
        ...
        public OrdersBuilder restaurant(User r) {
            o.setRestaurant(r);
            return this;
        }

        public OrdersBuilder orderNumber(String n) {
            o.setOrderNumber(n);
            return this;
        }

        public OrdersBuilder tableNumber(String t) {
            o.setTableNumber(t);
            return this;
        }

        public OrdersBuilder subtotal(Double s) {
            o.setSubtotal(s);
            return this;
        }

        public OrdersBuilder taxAmount(Double t) {
            o.setTaxAmount(t);
            return this;
        }

        public OrdersBuilder discountType(DiscountType d) {
            o.setDiscountType(d);
            return this;
        }

        public OrdersBuilder discountValue(Double v) {
            o.setDiscountValue(v);
            return this;
        }

        public OrdersBuilder discountAmount(Double a) {
            o.setDiscountAmount(a);
            return this;
        }

        public OrdersBuilder pointsRedeemed(Double p) {
            o.setPointsRedeemed(p);
            return this;
        }

        public OrdersBuilder total(Double t) {
            o.setTotal(t);
            return this;
        }

        public OrdersBuilder status(OrderStatus s) {
            o.setStatus(s);
            return this;
        }

        public OrdersBuilder paymentMethod(PaymentMethod m) {
            o.setPaymentMethod(m);
            return this;
        }

        public OrdersBuilder paymentStatus(PaymentStatus s) {
            o.setPaymentStatus(s);
            return this;
        }

        public OrdersBuilder customerName(String n) {
            o.setCustomerName(n);
            return this;
        }

        public OrdersBuilder customerPhone(String p) {
            o.setCustomerPhone(p);
            return this;
        }

        public OrdersBuilder notes(String n) {
            o.setNotes(n);
            return this;
        }

        public OrdersBuilder createdBy(User u) {
            o.setCreatedBy(u);
            return this;
        }

        public OrdersBuilder waiterName(String n) {
            o.setWaiterName(n);
            return this;
        }

        public OrdersBuilder isOffline(Boolean i) {
            o.setIsOffline(i);
            return this;
        }

        public OrdersBuilder offlineId(String i) {
            o.setOfflineId(i);
            return this;
        }

        public OrdersBuilder syncedAt(LocalDateTime s) {
            o.setSyncedAt(s);
            return this;
        }

        public OrdersBuilder orderType(OrderType t) {
            o.setOrderType(t);
            return this;
        }

        public OrdersBuilder tokenNumber(String t) {
            o.setTokenNumber(t);
            return this;
        }

        public OrdersBuilder mergedTables(String t) {
            o.setMergedTables(t);
            return this;
        }

        public OrdersBuilder covers(Integer c) {
            o.setCovers(c);
            return this;
        }

        public OrdersBuilder billTemplate(String t) {
            o.setBillTemplate(t);
            return this;
        }

        public OrdersBuilder doctorName(String n) {
            o.setDoctorName(n);
            return this;
        }

        public OrdersBuilder numberOfDays(String d) {
            o.setNumberOfDays(d);
            return this;
        }

        public OrdersBuilder customerFirm(String f) {
            o.setCustomerFirm(f);
            return this;
        }

        public OrdersBuilder printWithGst(Boolean p) {
            o.setPrintWithGst(p);
            return this;
        }
