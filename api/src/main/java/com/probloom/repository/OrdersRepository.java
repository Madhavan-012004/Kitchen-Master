...
public interface OrdersRepository extends JpaRepository<Orders, Long> {
        ...
        List<Orders> findByRestaurantAndStatusNotInOrderByCreatedAtDesc(@Param("restaurant") User restaurant,
                        @Param("statuses") List<Orders.OrderStatus> statuses);
        ...
        List<Orders> findByRestaurantAndStatusOrderByCreatedAtDesc(@Param("restaurant") User restaurant,
        ...
        @Query("SELECT DISTINCT o FROM Orders o LEFT JOIN FETCH o.items WHERE o.restaurant = :restaurant AND o.tableNumber = :tableNumber")
        List<Orders> findByRestaurantAndTableNumber(@Param("restaurant") User restaurant,
                        @Param("tableNumber") String tableNumber);

        @Query("SELECT DISTINCT o FROM Orders o LEFT JOIN FETCH o.items WHERE o.restaurant = :restaurant AND o.tableNumber = :tableNumber AND o.tokenNumber = :tokenNumber")
        List<Orders> findByRestaurantAndTableNumberAndTokenNumber(@Param("restaurant") User restaurant,
                        @Param("tableNumber") String tableNumber, @Param("tokenNumber") String tokenNumber);
        ...
        List<Orders> findByRestaurantAndTableNumberAndStatusNotInOrderByCreatedAtDesc(
                        @Param("restaurant") User restaurant, @Param("tableNumber") String tableNumber,
                        @Param("statuses") List<Orders.OrderStatus> statuses);
        ...
        List<Orders> findByRestaurantAndCreatedAtBetweenOrderByCreatedAtDesc(
                        @Param("restaurant") User restaurant, @Param("from") LocalDateTime from,
        ...
        List<Orders> findByRestaurantInAndCreatedAtBetweenOrderByCreatedAtDesc(
                        @Param("restaurants") List<User> restaurants, @Param("from") LocalDateTime from,
                        @Param("to") LocalDateTime to);
        ...
        Double sumRevenueByRestaurantAndDateRange(@Param("restaurant") User restaurant,
        ...
        Long countOrdersByRestaurantAndDateRange(@Param("restaurant") User restaurant,
                        @Param("from") LocalDateTime from, @Param("to") LocalDateTime to);
        ...
        Long findMaxTokenNumberToday(@Param("restaurantId") Long restaurantId,
        ...
        List<Orders> findByCreatedByAndStatusOrderByCreatedAtDesc(@Param("waiter") User waiter,
                        @Param("status") Orders.OrderStatus status);
}
