...
public class AttendanceService {
    ...
    public Attendance getActiveSession(@NonNull User employee) {
        String today = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        return attendanceRepository.findFirstByEmployeeAndDateAndStatusOrderByCheckInTimeDesc(
                employee, today, Attendance.AttendanceStatus.ACTIVE).orElse(null);
    }
