...
public class CustomerService {
    ...
    public Customer getCustomerByPhone(@NonNull Long restaurantId, @NonNull String phone) {
        return customerRepository.findByRestaurantIdAndPhone(restaurantId, phone).orElse(null);
    }
