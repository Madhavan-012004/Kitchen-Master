...
public class TransactionService {
    ...
    public List<Transaction> getByDateRange(@NonNull User restaurant, @NonNull LocalDateTime start,
    ...
    public Transaction createOrUpdateByInvoice(
        ...
        Optional<Transaction> existing = transactionRepository.findByRestaurantAndInvoiceNumber(restaurant,
                invoiceNumber);
