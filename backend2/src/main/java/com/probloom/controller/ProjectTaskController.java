...
public class ProjectTaskController {
    ...
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        ...
        if (body.containsKey("description")) task.setDescription(str(body, "description"));
        if (body.containsKey("priority"))    task.setPriority(str(body, "priority"));
        if (body.containsKey("assigneeName"))task.setAssigneeName(str(body, "assigneeName"));
