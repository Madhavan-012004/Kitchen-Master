...
public class AuthService {
    ...
    public Map<String, Object> register(String name, String email, String password, String restaurantName, String phone, String address, 
        ...
        if (name == null || name.trim().isEmpty()) throw new BadRequestException("Name is required");
        if (email == null || email.trim().isEmpty()) throw new BadRequestException("Email is required");
        if (restaurantName == null || restaurantName.trim().isEmpty()) throw new BadRequestException("Restaurant Name is required");
        if (password == null || password.trim().isEmpty()) throw new BadRequestException("Password is required");
    ...
    public Map<String, Object> login(String email, String password) {
        ...
        if (!user.getIsActive()) throw new BadRequestException("Account is deactivated");
        // if (!Boolean.TRUE.equals(user.getIsApproved()) && !Boolean.TRUE.equals(user.getIsProBloomAdmin())) {
        //     throw new BadRequestException("Your account is pending verification by the ProBloom team. Please wait for the activation email.");
        // }
    ...
    public User updateProfile(@NonNull Long userId, @NonNull Map<String, Object> updates) {
        ...
        if (updates.containsKey("restaurantName")) user.setRestaurantName((String) updates.get("restaurantName"));
        ...
        if (updates.containsKey("longitude")) user.setLongitude(parseOptionalDouble(updates, "longitude", user.getLongitude()));
        if (updates.containsKey("geofenceRadius")) user.setGeofenceRadius(parseOptionalDouble(updates, "geofenceRadius", user.getGeofenceRadius()));
        if (updates.containsKey("onboardingStep")) user.setOnboardingStep(parseOptionalInt(updates, "onboardingStep", user.getOnboardingStep()));
        
        if (updates.containsKey("onboardingCompleted")) user.setOnboardingCompleted((Boolean) updates.get("onboardingCompleted"));
        if (updates.containsKey("totalTables")) user.setTotalTables(parseOptionalInt(updates, "totalTables", user.getTotalTables()));
        
        // --- PRINTER SETTINGS ---
        if (updates.containsKey("acTables")) user.setAcTables((String) updates.get("acTables"));
        if (updates.containsKey("acChargePercentage")) {
            user.setAcChargePercentage(parseOptionalDouble(updates, "acChargePercentage", user.getAcChargePercentage() != null ? user.getAcChargePercentage() : 20.0));
        }
        if (updates.containsKey("kitchenPrinterIp")) user.setKitchenPrinterIp((String) updates.get("kitchenPrinterIp"));
        if (updates.containsKey("counterPrinterIp")) user.setCounterPrinterIp((String) updates.get("counterPrinterIp"));
        if (updates.containsKey("billPrinterEnabled")) user.setBillPrinterEnabled((Boolean) updates.get("billPrinterEnabled"));
        if (updates.containsKey("kotPrinterEnabled")) user.setKotPrinterEnabled((Boolean) updates.get("kotPrinterEnabled"));
        if (updates.containsKey("categoryPrinterEnabled")) user.setCategoryPrinterEnabled((Boolean) updates.get("categoryPrinterEnabled"));
        if (updates.containsKey("autoPrintEnabled")) user.setAutoPrintEnabled((Boolean) updates.get("autoPrintEnabled"));
        if (updates.containsKey("consolidatedReceipt")) user.setConsolidatedReceipt((Boolean) updates.get("consolidatedReceipt"));
        if (updates.containsKey("reprintKOT")) user.setReprintKOT((Boolean) updates.get("reprintKOT"));
        if (updates.containsKey("reprintBill")) user.setReprintBill((Boolean) updates.get("reprintBill"));
        if (updates.containsKey("largeFontKOT")) user.setLargeFontKOT((Boolean) updates.get("largeFontKOT"));
        if (updates.containsKey("itemWiseKOT")) user.setItemWiseKOT((Boolean) updates.get("itemWiseKOT"));
        ...
        if (updates.containsKey("manualQuantity")) user.setManualQuantity((Boolean) updates.get("manualQuantity"));
        if (updates.containsKey("lowStockAlert")) user.setLowStockAlert((Boolean) updates.get("lowStockAlert"));
        if (updates.containsKey("allowNoStockSale")) user.setAllowNoStockSale((Boolean) updates.get("allowNoStockSale"));
        if (updates.containsKey("trackCustomerDetail")) user.setTrackCustomerDetail((Boolean) updates.get("trackCustomerDetail"));
        
        if (updates.containsKey("menuLayout")) user.setMenuLayout((String) updates.get("menuLayout"));
        if (updates.containsKey("menuColorStyle")) user.setMenuColorStyle((String) updates.get("menuColorStyle"));
        if (updates.containsKey("menuItemColumnCount")) user.setMenuItemColumnCount(parseOptionalInt(updates, "menuItemColumnCount", user.getMenuItemColumnCount()));

        // --- ONLINE ORDER SETTINGS ---
        if (updates.containsKey("onlineAutoAccept")) user.setOnlineAutoAccept((Boolean) updates.get("onlineAutoAccept"));
        if (updates.containsKey("onlineAutoPrint")) user.setOnlineAutoPrint((Boolean) updates.get("onlineAutoPrint"));
        if (updates.containsKey("onlinePrintCounter")) user.setOnlinePrintCounter((Boolean) updates.get("onlinePrintCounter"));
        if (updates.containsKey("onlinePrintKitchen")) user.setOnlinePrintKitchen((Boolean) updates.get("onlinePrintKitchen"));
        if (updates.containsKey("onlineNotification")) user.setOnlineNotification((Boolean) updates.get("onlineNotification"));
        if (updates.containsKey("onlineStockActivateTime")) user.setOnlineStockActivateTime((Boolean) updates.get("onlineStockActivateTime"));

        // --- WHATSAPP SETTINGS ---
        if (updates.containsKey("whatsappCountryCode")) user.setWhatsappCountryCode((String) updates.get("whatsappCountryCode"));
        if (updates.containsKey("whatsappDetailedBill")) user.setWhatsappDetailedBill((Boolean) updates.get("whatsappDetailedBill"));
        ...
        if (updates.containsKey("printLanguage")) user.setPrintLanguage((String) updates.get("printLanguage"));
        if (updates.containsKey("accentColor")) user.setAccentColor((String) updates.get("accentColor"));
    ...
    public User completeOnboarding(@NonNull Long userId, Integer step, Map<String, Object> data) {
        ...
        if (data != null) {
            if (data.containsKey("restaurantName")) user.setRestaurantName((String) data.get("restaurantName"));
            ...
            if (data.containsKey("currency")) user.setCurrency((String) data.get("currency"));
            if (data.containsKey("gstNumber")) user.setGstNumber((String) data.get("gstNumber"));
            if (data.containsKey("taxRate") && data.get("taxRate") != null) user.setTaxRate(Double.valueOf(data.get("taxRate").toString()));
            if (data.containsKey("latitude") && data.get("latitude") != null) user.setLatitude(Double.valueOf(data.get("latitude").toString()));
            if (data.containsKey("longitude") && data.get("longitude") != null) user.setLongitude(Double.valueOf(data.get("longitude").toString()));
        }
    ...
    @NonNull
    public User addStaff(@NonNull User owner, String name, String email, String password, String roleStr, List<String> assignedTables) {
    ...
    public User updateStaff(@NonNull User owner, @NonNull Long staffId, @NonNull Map<String, Object> updates) {
        ...
        if (updates.containsKey("name")) staff.setName((String) updates.get("name"));
        ...
        if (updates.containsKey("password") && updates.get("password") != null && !updates.get("password").toString().isEmpty()) {
        ...
        if (updates.containsKey("assignedTables")) {
            ...
            List<String> tables = rawTables.stream().map(Object::toString).collect(java.util.stream.Collectors.toList());
    ...
    public Map<String, Object> firebaseLogin(String phone) {
        if (phone == null || phone.isEmpty()) throw new BadRequestException("Phone number is required");
    ...
    private String generateToken(User user) {
        Long ownerId = user.getRole() == User.Role.OWNER ? user.getId()
                : (user.getParentOwner() != null ? user.getParentOwner().getId() : (user.getRole() == User.Role.CUSTOMER ? 0L : user.getId()));
    ...
    public Map<String, Object> sanitizeUser(User user) {
        // Resolve the effective "owner" for restaurant-wide settings (metadata, tables, etc.)
        User owner = (user.getRole() == User.Role.OWNER) ? user : user.getParentOwner();
        ...
        java.time.LocalDateTime expiresAt = owner != null ? owner.getSubscriptionExpiresAt() : user.getSubscriptionExpiresAt();
        if (expiresAt != null) {
        ...
        u.put("categoryPrinterEnabled", owner != null ? owner.getCategoryPrinterEnabled() : user.getCategoryPrinterEnabled());
        ...
        u.put("onlineStockActivateTime", owner != null ? owner.getOnlineStockActivateTime() : user.getOnlineStockActivateTime());
    ...
    private Double parseOptionalDouble(Map<String, Object> data, String key, Double defaultValue) {
        if (!data.containsKey(key) || data.get(key) == null || data.get(key).toString().isEmpty()) return defaultValue;
        try {
